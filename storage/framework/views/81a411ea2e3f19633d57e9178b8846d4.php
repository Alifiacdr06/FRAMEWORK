...
<body>
    <div class="container m-5">
        ...
        <div class="list-group  mt-4">
            <a href="<?php echo e(url('/fia')); ?>" class="list-group-item list-group-item-action"> Alifia's Personal Web
                    </a>
        </div>      
...
<?php /**PATH C:\xampp\htdocs\basic-route\resources\views/routing.blade.php ENDPATH**/ ?>